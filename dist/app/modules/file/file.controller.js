...
const createFile = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const ext =
      (_a = req.file.originalname.split(".").pop()) === null || _a === void 0
        ? void 0
        : _a.toLowerCase();
    let fileType = "doc";
    if (ext) {
    ...
    try {
      ...
      if (folderId) {
        ...
        if (mongoose_1.default.Types.ObjectId.isValid(String(folderId))) {
          folderObjectId = new mongoose_1.default.Types.ObjectId(
            String(folderId)
          );
        } else {
      ...
      const files = yield (0, file_service_1.getFilesService)(
        authReq.user._id,
        fileType,
        folderObjectId
      );
...
const deleteFile = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      const deleted = yield (0, file_service_1.deleteFileService)(
        fileId,
        authReq.user._id
      );
      if (!deleted) {
...
const getRecentItems = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      const recentItems = yield (0, file_service_1.getRecentItemsService)(
